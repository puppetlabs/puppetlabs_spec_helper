...
- Add Ruby 4.0 / Puppet 9 lane to ci/nightly, source gems from puppetcore [#488](https://github.com/puppetlabs/puppetlabs_spec_helper/pull/488) ([LukasAud](https://github.com/LukasAud))
